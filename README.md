...
⚠️ If using Vault Enterprise, you must specify a namespace using the `--namespace` flag in relevant commands.
...
⚠️ For certificate-related configuration, follow the 'NEXT STEPS' section in the command output, which provides examples for default, insecure, and custom CA scenarios.
